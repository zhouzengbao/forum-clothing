...
//        httpPost.setHeader("User-Agent", "Mozilla/4.0 (compatible; MSIE 5.0; Windows NT; DigExt)");
    ...
    public static String doPostXml(String url, String xml, Map<String, String> headers)
        ...
        s.setContentEncoding(new BasicHeader(HTTP.CONTENT_TYPE, "text/xml"));
        // 设置参数到请求对象中
        httpPost.setEntity(s);
        System.out.println("请求地址：" + url);
        // System.out.println("请求参数："+nvps.toString());
    ...
    public static HttpClientResult doDelete(String url, Map<String, String> headers, Map<String, String> params)
        throws Exception {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpDelete httpDelete = new HttpDelete(url);
