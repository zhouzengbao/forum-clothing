<template>
	<view class="upload-content">
		...
		<!-- 新增按钮 -->
		<view class="upload-add-btn" v-if="isEdit && rduLength > 0" @click="chooseImage"></view>
...
export default {
	...
	methods: {
		...
		async uploadFiles(files){
			...
			const result = await this.$upload('v1/common/uploadImage', files[0] , {} , {lshowLoading:true,onProgressUpdate:(res)=>{
