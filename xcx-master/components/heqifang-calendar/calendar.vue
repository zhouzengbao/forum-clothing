<template>
	<view class="uni-calendar" @touchmove.stop.prevent="clean">
		...
		<view  class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}"> <!-- v-if="insert || show"-->
			<view class="uni-calendar__header uni-calendar--fixed-top">	<!-- v-if="!insert"-->
