<template>
	<view class="mix-loading flex justify-center align-center">
		<view v-if="!isTimeout" class="flex justify-center align-center">
			<view v-if="mask" class="mask" @click.stop.prevent="stopPrevent" @touchmove.stop.prevent="stopPrevent"></view>
			<!-- 黑底菊花 -->
			<view v-if="type === 1" class="chry flex  flex-direction  justify-center align-center">
